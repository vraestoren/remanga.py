...
class Remanga:
	...
	def login(
		...
		response = self._post("/users/login/", data)
	...
	def like_comment(
		...
		return self._post("/activity/votes/", data)
	...
	def get_title_comments(
		...
		return self._get(
			f"{self.api}/activity/comments", params)
	...
	def bill_promo_code(self, promo_code: str) -> dict:
		...
		return self._post("/billing/promo-codes/", data)
	...
	def create_publishers(
		...
		return self._post("/publishers/", data)
	...
	def rate_title(
		...
		return self._post("/activity/ratings/", data)
	...
	def reset_password(self, email: str) -> dict:
		...
		return self._post("/users/password-reset/", data)
	...
	def create_billing(
		...
		return self._post("/v2/billing/charge/", data)
	...
	def create_post(
		...
		return self._post("/v2/forum/", data)
